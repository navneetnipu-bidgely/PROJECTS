...
var gid=pm.variables.get("gid");
var t0=pm.variables.get("t0");
var t1=pm.variables.get("t1");
...
var billing_cycles_url=url+"/billingdata/users/"+uuid+"/homes/"+hid+"/billingcycles?t0="+t+"&t1="+t1;
